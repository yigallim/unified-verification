...
export const PartnerDemo = () => {
  ...
  const handleApplyWithUVS = () => {
    ...
    setTimeout(() => {
      ...
      const passport = stored ? JSON.parse(stored) : {};

      setName(passport.name || "Azlan Bin Ahmad");
      setBusinessName(passport.business_name || "Azlan's Warung");
      setRegNo(passport.business_reg_no || "SSM2020-123456");
      setAddress(passport.address || "123 Jalan Niaga, 50450 Kuala Lumpur");
      setBusinessType("Sole Proprietorship");
      setBranch("KL Main Branch");
